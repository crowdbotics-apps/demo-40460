"""
Django settings for demo_40460 project.
...
WSGI_APPLICATION = 'demo_40460.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40460 API",
    "DESCRIPTION": "API documentation for demo_40460 App",
    "VERSION": "v1",
}
